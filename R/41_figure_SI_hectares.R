...
# F1 industrial mining ----------------------------------------------------

### GDP industrial
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "hectares_gdp_yearly")
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "hectares_gdp_pooled")
...
p_dat <- p_dat %>% dplyr::filter(Variable %in% variables_industrial_yearly) %>%
  ...
  dplyr::mutate(unit = "Impact of industrial mining (thousand ha) on GDP per capita growth") 
...
p_gdp_year <- p_dat %>%
  ...
  ggplot2::scale_y_continuous(limits = c(-2.7, 5.1), expand = c(0, 0)) +
...
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "hectares_def_rel_yearly")
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "hectares_def_rel_pooled")
...
p_dat <- p_dat %>% dplyr::filter(Variable %in% variables_industrial_yearly) %>%
  dplyr::mutate(freq = "yearly") %>%
  dplyr::mutate(unit = "Impact of industrial mining (ha/municipality area km2) on forest loss (ha/km2)") 
...
p_deforestation_hect_year <- p_dat %>%
  ...
  ggplot2::scale_y_continuous(limits = c(-0.21, 0.14), expand = c(0, 0)) +
...
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "hectares_def_abs_yearly")
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "hectares_def_abs_pooled")
...
p_dat <- p_dat %>% dplyr::filter(Variable %in% variables_industrial_yearly) %>%
  dplyr::mutate(freq = "yearly") %>%
  dplyr::mutate(unit = "Impact of industrial mining (ha) on forest loss (ha)") 
...
p_deforestation_hect_abs_year <- p_dat %>%
  ...
  ggplot2::facet_wrap(Unit~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
  ggplot2::scale_y_continuous(limits = c(-1.4, 1.6), expand = c(0, 0)) +
...
p_dat <- p_dat %>% dplyr::filter(Variable %in% variables_garimpo_yearly) %>%
  dplyr::mutate(freq = "yearly") %>%
  dplyr::mutate(unit = "Impact of garimpo mining (thousand ha) on GDP per capita growth") 
...
p_gdp_year <- p_dat %>%
  ...
  ggplot2::facet_wrap(Unit~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "GDP impact estimate") +
  ggplot2::scale_y_continuous(limits = c(-1.9, 3.1), expand = c(0, 0)) +
  ggplot2::scale_color_manual(name = NULL, values =  viridis::viridis(10)[c(1, 8)]) + 
  ggplot2::theme_bw() +
  ggplot2::theme(axis.text.x = element_text(size = 14),
                 axis.text.y = element_text(size = 14),
...
p_dat <- p_dat %>% dplyr::filter(Variable %in% variables_garimpo_yearly) %>%
  dplyr::mutate(freq = "yearly") %>%
  dplyr::mutate(unit = "Impact of garimpo mining (ha/municipality area km2) on forest loss (ha/km2)") 
...
p_deforestation_hect_year <- p_dat %>%
  ...
  ggplot2::facet_wrap(Unit~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
  ggplot2::scale_y_continuous(limits = c(-1.1, 2.8), expand = c(0, 0)) +
  ggplot2::scale_color_manual(name = NULL, values = viridis::inferno(8)[c(1, 5)]) +
  ggplot2::theme_bw() +
  ggplot2::theme(axis.text.x = element_text(size = 14),
                 axis.text.y = element_text(size = 14),
...
p_dat <- p_dat %>% dplyr::filter(Variable %in% variables_garimpo_yearly) %>%
  dplyr::mutate(freq = "yearly") %>%
  dplyr::mutate(unit = "Impact of garimpo mining (ha) on forest loss (ha)") 
...
p_deforestation_hect_abs_year <- p_dat %>%
  ...
  ggplot2::facet_wrap(Unit~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
  ggplot2::scale_y_continuous(limits = c(-0.9, 6.1), expand = c(0, 0)) +
  ggplot2::scale_color_manual(name = NULL, values = viridis::mako(8)[c(1, 5)]) + 
  ggplot2::theme_bw() +
  ggplot2::theme(axis.text.x = element_text(size = 14),
                 axis.text.y = element_text(size = 14),
