...
if (mining_type == "industrial"){
  ...
  X <- M_matched_industrial %>% 
    ...
    as.matrix()
  YX <- cbind(Y, X)
  write.csv(YX, file = paste0("./data/cem/cem_model_input/YX_rel_pooled_industrial_", matching_model, "_",from_yr, "-", to_yr, "_", window_yrs, "y", ".csv"), row.names = FALSE)
  ...
  X <- M_matched_industrial %>% 
    ...
    as.matrix()
  YX <- cbind(Y, X)
  write.csv(YX, file = paste0("./data/cem/cem_model_input/YX_abs_pooled_industrial_", matching_model, "_", from_yr, "-", to_yr, "_", window_yrs, "y", ".csv"), row.names = FALSE)
  ...
  X <- M_matched_garimpo %>% 
    ...
    as.matrix()
  YX <- cbind(Y, X)
  write.csv(YX, file = paste0("./data/cem/cem_model_input/YX_rel_pooled_garimpo_", matching_model, "_",from_yr, "-", to_yr, "_", window_yrs, "y", ".csv"), row.names = FALSE)
  ...
  X <- M_matched_garimpo %>% 
    ...
    as.matrix()
  YX <- cbind(Y, X)
  write.csv(YX, file = paste0("./data/cem/cem_model_input/YX_abs_pooled_garimpo_", matching_model, "_", from_yr, "-", to_yr, "_", window_yrs, "y", ".csv"), row.names = FALSE)
...
if(mining_type == "industrial"){
  ...
  if(dependent == "gdp"){
    YX <- read.csv2(file = paste0("./data/cem/cem_model_input/YX_gdp_pooled_industrial_", matching_model, "_2005-2015_5y.csv"), sep = ",", stringsAsFactors = FALSE) %>% mutate_all(as.numeric)
  }
  if(dependent == "rel"){
    YX <- read.csv2(file = paste0("./data/cem/cem_model_input/YX_rel_pooled_industrial_", matching_model, "_2005-2015_5y.csv"), sep = ",", stringsAsFactors = FALSE) %>% mutate_all(as.numeric)
  }
  if(dependent == "abs"){
    YX <- read.csv2(file = paste0("./data/cem/cem_model_input/YX_abs_pooled_industrial_", matching_model, "_2005-2015_5y.csv"), sep = ",", stringsAsFactors = FALSE) %>% mutate_all(as.numeric)
  }
  
} else {
  
  if(dependent == "gdp"){
    YX <- read.csv2(file = paste0("./data/cem/cem_model_input/YX_gdp_pooled_garimpo_", matching_model, "_2005-2015_5y.csv"), sep = ",", stringsAsFactors = FALSE) %>% mutate_all(as.numeric)
  }
  if(dependent == "rel"){
    YX <- read.csv2(file = paste0("./data/cem/cem_model_input/YX_rel_pooled_garimpo_", matching_model, "_2005-2015_5y.csv"), sep = ",", stringsAsFactors = FALSE) %>% mutate_all(as.numeric)
  }
  if(dependent == "abs"){
    YX <- read.csv2(file = paste0("./data/cem/cem_model_input/YX_abs_pooled_garimpo_", matching_model, "_2005-2015_5y.csv"), sep = ",", stringsAsFactors = FALSE) %>% mutate_all(as.numeric)
  }
...
save(store, file = paste0("data/intermediary/MCMC_draws_matching/", dependent, "_pooled_", mining_type, "_", matching_model, "_", Sys.time(), ".Rdata"))
...
save(store_impacts, file = paste0("data/cem/sdm_impact_estimates/draws/impacts_", dependent, "_pooled_", mining_type, "_", matching_model, "_", Sys.time(), ".Rdata"))
...
# save as Excel
write.csv(impact_summary, file = paste0("data/cem/sdm_impact_estimates/summaries/", dependent, "_pooled_", mining_type, "_", matching_model, "_" , ntot, "draws_", Sys.time(), ".csv"), row.names = FALSE)
