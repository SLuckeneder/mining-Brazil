...
# W4
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "gdp_yearly_2005-2015_5y_W4")
p_dat_W4 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
# W7
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "gdp_yearly_2005-2015_5y_W7")
p_dat_W7 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
# W10
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "gdp_yearly_2005-2015_5y_W10")
p_dat_W10 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
p_dat$gr <- factor(p_dat$gr, levels = c("Direct impact k = 4", "Direct impact k = 7", "Direct impact k = 10",
                                        "Indirect impact k = 4", "Indirect impact k = 7", "Indirect impact k = 10"))

p_gdp_year_industrial <- p_dat %>%
  dplyr::filter(Type == "Industrial") %>%
  dplyr::mutate(Model = "Impact of industrial mining on GDP per capita growth") %>%
...
p_gdp_year_garimpo <- p_dat %>%
  ...
  dplyr::mutate(Model = "Impact of garimpo mining on GDP per capita growth") %>%
  ggplot2::ggplot(aes(x = Variable, color = Impact, linetype = Unit)) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W4)), position=position_dodge(.5), size = 2) +
  ggplot2::geom_line(aes(y = as.numeric(Mean.W4), group = gr), position=position_dodge(.5), size = 1) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W7)), position=position_dodge(.5), size = 2) +
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "gdp_pooled_2005-2015_5y_W4")
p_dat_W4 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "gdp_pooled_2005-2015_5y_W7")
p_dat_W7 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "gdp_pooled_2005-2015_5y_W10")
p_dat_W10 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
# W4
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_rel_yearly_2005-2015_5y_W4")
p_dat_W4 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
# W7
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_rel_yearly_2005-2015_5y_W7")
p_dat_W7 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
# W10
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_rel_yearly_2005-2015_5y_W10")
p_dat_W10 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
p_def_rel_year_industrial <- p_dat %>%
  dplyr::filter(Type == "Industrial") %>%
  dplyr::mutate(Model = "Impact of industrial mining on forest loss (ha/km2)") %>%
  ggplot2::ggplot(aes(x = Variable, color = Impact, linetype = Unit)) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W4)), position=position_dodge(.5), size = 2) +
  ggplot2::geom_line(aes(y = as.numeric(Mean.W4), group = gr), position=position_dodge(.5), size = 1) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W7)), position=position_dodge(.5), size = 2) +
  ...
  ggplot2::geom_errorbar(aes(ymin= CI.2.5.W10, ymax= CI.97.5.W10), width=.4,
                         position=position_dodge(.5), size = 1) +
  ggplot2::scale_y_continuous(limits = c(-0.55, 0.3), expand = c(0, 0)) +
  ggplot2::geom_hline(yintercept=0) +
  ggplot2::facet_wrap(Model~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
...
p_def_rel_year_garimpo <- p_dat %>%
  dplyr::filter(Type == "Garimpo") %>%
  dplyr::mutate(Model = "Impact of garimpo mining on forest loss (ha/km2)") %>%
  ggplot2::ggplot(aes(x = Variable, color = Impact, linetype = Unit)) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W4)), position=position_dodge(.5), size = 2) +
  ggplot2::geom_line(aes(y = as.numeric(Mean.W4), group = gr), position=position_dodge(.5), size = 1) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W7)), position=position_dodge(.5), size = 2) +
  ...
  ggplot2::geom_errorbar(aes(ymin= CI.2.5.W10, ymax= CI.97.5.W10), width=.4,
                         position=position_dodge(.5), size = 1) +
  ggplot2::scale_y_continuous(limits = c(-0.55, 1.2), expand = c(0, 0)) +
  ggplot2::geom_hline(yintercept=0) +
  ggplot2::facet_wrap(Model~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
  ggplot2::scale_color_manual(name = NULL, values = viridis::inferno(8)[c(1, 5)]) + 
...
### pre/post 2010 estimates
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_rel_pooled_2005-2015_5y_W4")
p_dat_W4 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_rel_pooled_2005-2015_5y_W7")
p_dat_W7 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_rel_pooled_2005-2015_5y_W10")
p_dat_W10 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
# W4
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_abs_yearly_2005-2015_5y_W4")
p_dat_W4 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
# W7
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_abs_yearly_2005-2015_5y_W7")
p_dat_W7 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
# W10
impacts_yearly <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_abs_yearly_2005-2015_5y_W10")
p_dat_W10 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_yearly))
...
p_def_abs_year_industrial <- p_dat %>%
  dplyr::filter(Type == "Industrial") %>%
  dplyr::mutate(Model = "Impact of industrial mining on forest loss (thousand ha)") %>%
  ggplot2::ggplot(aes(x = Variable, color = Impact, linetype = Unit)) +
  ...
  ggplot2::geom_errorbar(aes(ymin= CI.2.5.W10 / 1000, ymax= CI.97.5.W10 / 1000), width=.4,
                         position=position_dodge(.5), size = 1) +
  ggplot2::scale_y_continuous(limits = c(-4, 0.9), expand = c(0, 0)) +
  ggplot2::geom_hline(yintercept=0) +
  ggplot2::facet_wrap(Model~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
...
p_def_abs_year_garimpo <- p_dat %>%
  dplyr::filter(Type == "Garimpo") %>%
  dplyr::mutate(Model = "Impact of garimpo mining on forest loss (thousand ha)") %>%
  ggplot2::ggplot(aes(x = Variable, color = Impact, linetype = Unit)) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W4) / 1000), position=position_dodge(.5), size = 2) +
  ggplot2::geom_line(aes(y = as.numeric(Mean.W4) / 1000, group = gr), position=position_dodge(.5), size = 1) +
  ggplot2::geom_point(aes(y = as.numeric(Mean.W7) / 1000), position=position_dodge(.5), size = 2) +
  ...
  ggplot2::geom_errorbar(aes(ymin= CI.2.5.W10 / 1000, ymax= CI.97.5.W10 / 1000), width=.4,
                         position=position_dodge(.5), size = 1) +
  ggplot2::scale_y_continuous(limits = c(-2, 15), expand = c(0, 0)) +
  ggplot2::geom_hline(yintercept=0) +
  ggplot2::facet_wrap(Model~., scales = "free_y") +
  ggplot2::labs(x = NULL, y = "Forest loss impact estimate") +
  ggplot2::scale_color_manual(name = NULL, values = viridis::mako(8)[c(1, 5)]) + 
...
### pre/post 2010 estimates
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_abs_pooled_2005-2015_5y_W4")
p_dat_W4 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_abs_pooled_2005-2015_5y_W7")
p_dat_W7 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
...
impacts_pooled <- list.files("data/impact_estimates/summaries/SI/", pattern = "def_abs_pooled_2005-2015_5y_W10")
p_dat_W10 <- read.csv(file = paste0("data/impact_estimates/summaries/SI/", impacts_pooled))
